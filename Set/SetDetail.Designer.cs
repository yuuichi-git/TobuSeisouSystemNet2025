namespace Set {
    partial class SetDetail {
        ...
        private void InitializeComponent() {
            ...
            this.ComboBoxExMoveFlag = new CcControl.CcComboBox();
            this.labelEx14 = new CcControl.CcLabel();
            this.ComboBoxExFiveLap = new CcControl.CcComboBox();
            this.labelEx13 = new CcControl.CcLabel();
            this.CheckBoxExSun = new CcControl.CcCheckBox();
            this.CheckBoxExSat = new CcControl.CcCheckBox();
            this.CheckBoxExFri = new CcControl.CcCheckBox();
            this.CheckBoxExThu = new CcControl.CcCheckBox();
            this.CheckBoxExWed = new CcControl.CcCheckBox();
            this.CheckBoxExTue = new CcControl.CcCheckBox();
            this.CheckBoxExMon = new CcControl.CcCheckBox();
            ...
            this.ComboBoxExManagedSpaceCode = new CcControl.CcComboBox();
            this.labelEx7 = new CcControl.CcLabel();
            this.ComboBoxExFareCode = new CcControl.CcComboBox();
            this.labelEx6 = new CcControl.CcLabel();
            this.TextBoxExSetName2 = new CcControl.CcTextBox();
            this.labelEx5 = new CcControl.CcLabel();
            this.TextBoxExSetName1 = new CcControl.CcTextBox();
            this.labelEx4 = new CcControl.CcLabel();
            this.TextBoxExSetName = new CcControl.CcTextBox();
            this.labelEx3 = new CcControl.CcLabel();
            this.ComboBoxExWordCode = new CcControl.CcComboBox();
            this.labelEx2 = new CcControl.CcLabel();
            this.labelEx1 = new CcControl.CcLabel();
            this.TextBoxExSetCode = new CcControl.CcTextBox();
        ...
        private CcControl.CcTextBox TextBoxExSetCode;
        private CcControl.CcComboBox ComboBoxExWordCode;
        private CcControl.CcLabel labelEx2;
        private CcControl.CcTextBox TextBoxExSetName;
        private CcControl.CcLabel labelEx3;
        private CcControl.CcTextBox TextBoxExSetName2;
        private CcControl.CcLabel labelEx5;
        private CcControl.CcTextBox TextBoxExSetName1;
        private CcControl.CcLabel labelEx4;
        private CcControl.CcComboBox ComboBoxExFareCode;
        private CcControl.CcLabel labelEx6;
        private CcControl.CcComboBox ComboBoxExManagedSpaceCode;
        ...
        private CcControl.CcCheckBox CheckBoxExSat;
        private CcControl.CcCheckBox CheckBoxExFri;
        private CcControl.CcCheckBox CheckBoxExThu;
        private CcControl.CcCheckBox CheckBoxExWed;
        private CcControl.CcCheckBox CheckBoxExTue;
        private CcControl.CcCheckBox CheckBoxExMon;
        private CcControl.CcLabel labelEx12;
        private CcControl.CcComboBox ComboBoxExFiveLap;
        private CcControl.CcLabel labelEx13;
        private CcControl.CcComboBox ComboBoxExMoveFlag;
