namespace TobuSeisouSystemNet2025 {
    partial class StartProject {
        ...
        private void InitializeComponent() {
            TreeNode treeNode96 = new TreeNode("ファイル及びデータへのショートカット");
            TreeNode treeNode97 = new TreeNode("　　環境マネジメントマニュアル");
            TreeNode treeNode98 = new TreeNode("１　適用規格");
            TreeNode treeNode99 = new TreeNode("２　引用規格");
            TreeNode treeNode100 = new TreeNode("３　用語及び定義");
            TreeNode treeNode101 = new TreeNode("４.１　組織及びその状況の理解");
            TreeNode treeNode102 = new TreeNode("４.２　利害関係者のニーズ及び期待の理解");
            TreeNode treeNode103 = new TreeNode("４.３　環境マネジメントシステムの適用範囲の決定");
            TreeNode treeNode104 = new TreeNode("４.４　環境マネジメントシステム");
            TreeNode treeNode105 = new TreeNode("４　組織の状況", new TreeNode[] { treeNode101, treeNode102, treeNode103, treeNode104 });
            TreeNode treeNode106 = new TreeNode("５.１　リーダーシップ及びコミットメント");
            TreeNode treeNode107 = new TreeNode("５.２　環境方針");
            TreeNode treeNode108 = new TreeNode("５.３　組織の役割、責任及び権限");
            TreeNode treeNode109 = new TreeNode("５　リーダーシップ", new TreeNode[] { treeNode106, treeNode107, treeNode108 });
            TreeNode treeNode110 = new TreeNode("６.１.１　一般(リスク及び機会一覧表)");
            TreeNode treeNode111 = new TreeNode("６.１.２　環境側面");
            TreeNode treeNode112 = new TreeNode("６.１.３　順守義務(法的要求事項及びその他の要求事項)");
            TreeNode treeNode113 = new TreeNode("６.１.４　取組みのための計画策定");
            TreeNode treeNode114 = new TreeNode("６.１　リスク及び機会への取組み", new TreeNode[] { treeNode110, treeNode111, treeNode112, treeNode113 });
            TreeNode treeNode115 = new TreeNode("６.２.１　環境目標");
            TreeNode treeNode116 = new TreeNode("６.２.２　環境目標を達成するための取組みの計画策定");
            TreeNode treeNode117 = new TreeNode("６.２　環境目標及びそれを達成するための計画策定(環境マネジメントプログラム)", new TreeNode[] { treeNode115, treeNode116 });
            TreeNode treeNode118 = new TreeNode("６　計画", new TreeNode[] { treeNode114, treeNode117 });
            TreeNode treeNode119 = new TreeNode("７.１　資源");
            TreeNode treeNode120 = new TreeNode("７.２　力量");
            TreeNode treeNode121 = new TreeNode("７.３　認識");
            TreeNode treeNode122 = new TreeNode("７.４.１　一般");
            TreeNode treeNode123 = new TreeNode("７.４.２　内部コミュニケーション");
            TreeNode treeNode124 = new TreeNode("７.４.３　外部コミュニケーション");
            TreeNode treeNode125 = new TreeNode("７.４　コミュニケーション", new TreeNode[] { treeNode122, treeNode123, treeNode124 });
            TreeNode treeNode126 = new TreeNode("７.５.１　一般");
            TreeNode treeNode127 = new TreeNode("７.５.２　作成及び更新");
            TreeNode treeNode128 = new TreeNode("７.５.３　文書化した情報の管理");
            TreeNode treeNode129 = new TreeNode("７.５　文書管理", new TreeNode[] { treeNode126, treeNode127, treeNode128 });
            TreeNode treeNode130 = new TreeNode("７　支援(サポート)", new TreeNode[] { treeNode119, treeNode120, treeNode121, treeNode125, treeNode129 });
            TreeNode treeNode131 = new TreeNode("８.１　運用の計画及び管理");
            TreeNode treeNode132 = new TreeNode("８.２.１　緊急事態の可能性の特定");
            TreeNode treeNode133 = new TreeNode("８.２.２　緊急事態対応手順書の作成");
            TreeNode treeNode134 = new TreeNode("８.２.３　緊急事態対応訓練(対応手順のテスト)");
            TreeNode treeNode135 = new TreeNode("８.２.４　手順書の見直し");
            TreeNode treeNode136 = new TreeNode("８.２.５　取引先を含む利害関係者への情報提供");
            TreeNode treeNode137 = new TreeNode("８.２　緊急事態への準備及び対応", new TreeNode[] { treeNode132, treeNode133, treeNode134, treeNode135, treeNode136 });
            TreeNode treeNode138 = new TreeNode("８　運用", new TreeNode[] { treeNode131, treeNode137 });
            TreeNode treeNode139 = new TreeNode("９.１.１　一般");
            TreeNode treeNode140 = new TreeNode("９.１.２　順守評価");
            TreeNode treeNode141 = new TreeNode("９.１　監視、測定、分析及び評価", new TreeNode[] { treeNode139, treeNode140 });
            TreeNode treeNode142 = new TreeNode("９.２　内部監査");
            TreeNode treeNode143 = new TreeNode("９.３　マネジメントレビュー");
            TreeNode treeNode144 = new TreeNode("９　パフォーマンス評価", new TreeNode[] { treeNode141, treeNode142, treeNode143 });
            TreeNode treeNode145 = new TreeNode("１０.１　一般");
            TreeNode treeNode146 = new TreeNode("１０.２　不適合及び是正処置");
            TreeNode treeNode147 = new TreeNode("１０.３　継続的改善");
            TreeNode treeNode148 = new TreeNode("１０改善", new TreeNode[] { treeNode145, treeNode146, treeNode147 });
            TreeNode treeNode149 = new TreeNode("ISO14001", new TreeNode[] { treeNode97, treeNode98, treeNode99, treeNode100, treeNode105, treeNode109, treeNode118, treeNode130, treeNode138, treeNode144, treeNode148 });
            TreeNode treeNode150 = new TreeNode("00　巡回指導資料");
            TreeNode treeNode151 = new TreeNode("01　運転者台帳");
            TreeNode treeNode152 = new TreeNode("02　運行管理規定");
            TreeNode treeNode153 = new TreeNode("03　点呼記録簿・点呼執行要領");
            TreeNode treeNode154 = new TreeNode("04　乗務記録(運転日報)");
            TreeNode treeNode155 = new TreeNode("05　運行計画及び勤務割当表");
            TreeNode treeNode156 = new TreeNode("06　乗務実績一覧表(拘束時間管理表)");
            TreeNode treeNode157 = new TreeNode("07　運行記録計による記録");
            TreeNode treeNode158 = new TreeNode("08　運行指示書");
            TreeNode treeNode159 = new TreeNode("09　受注伝票");
            TreeNode treeNode160 = new TreeNode("10　運行管理者・整備管理者選任届出書");
            TreeNode treeNode161 = new TreeNode("11　運行管理者資格者証");
            TreeNode treeNode162 = new TreeNode("12　運行管理者研修手帳");
            TreeNode treeNode163 = new TreeNode("13　整備管理者研修手帳");
            TreeNode treeNode164 = new TreeNode("14　教育実施計画");
            TreeNode treeNode165 = new TreeNode("15　運転記録証明書又は無事故無違反証明書");
            TreeNode treeNode166 = new TreeNode("16　乗務員指導記録簿");
            TreeNode treeNode167 = new TreeNode("17　適性診断受診結果票及び指導記録");
            TreeNode treeNode168 = new TreeNode("18　適性診断受診計画表");
            TreeNode treeNode169 = new TreeNode("19　事故記録簿");
            TreeNode treeNode170 = new TreeNode("20　自動車事故報告書");
            TreeNode treeNode171 = new TreeNode("21　事業報告書・事業実績報告書");
            TreeNode treeNode172 = new TreeNode("22　役員変更届出書");
            TreeNode treeNode173 = new TreeNode("23　車両台帳・自動車検査証の写し");
            TreeNode treeNode174 = new TreeNode("24　整備管理規定等の規定類");
            TreeNode treeNode175 = new TreeNode("25　点検整備記録簿");
            TreeNode treeNode176 = new TreeNode("26　日常点検基準");
            TreeNode treeNode177 = new TreeNode("27　日常点検表");
            TreeNode treeNode178 = new TreeNode("28　定期点検基準");
            TreeNode treeNode179 = new TreeNode("29　定期点検整備実施計画表");
            TreeNode treeNode180 = new TreeNode("30　賃金台帳");
            TreeNode treeNode181 = new TreeNode("31　健康診断書・健康診断記録簿");
            TreeNode treeNode182 = new TreeNode("32　就業規則");
            TreeNode treeNode183 = new TreeNode("33　３６協定");
            TreeNode treeNode184 = new TreeNode("34　出勤簿");
            TreeNode treeNode185 = new TreeNode("35　運輸安全マネジメント関係");
            TreeNode treeNode186 = new TreeNode("36　労災保険加入台帳");
            TreeNode treeNode187 = new TreeNode("37　雇用保険加入台帳");
            TreeNode treeNode188 = new TreeNode("38　健康保険加入台帳・厚生年金加入台帳");
            TreeNode treeNode189 = new TreeNode("陸運局", new TreeNode[] { treeNode150, treeNode151, treeNode152, treeNode153, treeNode154, treeNode155, treeNode156, treeNode157, treeNode158, treeNode159, treeNode160, treeNode161, treeNode162, treeNode163, treeNode164, treeNode165, treeNode166, treeNode167, treeNode168, treeNode169, treeNode170, treeNode171, treeNode172, treeNode173, treeNode174, treeNode175, treeNode176, treeNode177, treeNode178, treeNode179, treeNode180, treeNode181, treeNode182, treeNode183, treeNode184, treeNode185, treeNode186, treeNode187, treeNode188 });
            TreeNode treeNode190 = new TreeNode("労働基準監督署");
            ...
            this.LabelExLocation = new ControlEx.CcLabelEx();
            this.LabelExIpAddress = new ControlEx.CcLabelEx();
            this.LabelExPcName = new ControlEx.CcLabelEx();
            ...
            this.LabelExStatusSqlServer = new ControlEx.CcLabelEx();
            this.LabelExDataBaseNameSqlServer = new ControlEx.CcLabelEx();
            this.LabelExServerNameSqlServer = new ControlEx.CcLabelEx();
            ...
            this.labelEx52 = new ControlEx.CcLabelEx();
            this.labelEx53 = new ControlEx.CcLabelEx();
            this.labelEx38 = new ControlEx.CcLabelEx();
            this.labelEx39 = new ControlEx.CcLabelEx();
            this.labelEx44 = new ControlEx.CcLabelEx();
            this.labelEx45 = new ControlEx.CcLabelEx();
            this.labelEx42 = new ControlEx.CcLabelEx();
            this.labelEx43 = new ControlEx.CcLabelEx();
            this.labelEx32 = new ControlEx.CcLabelEx();
            this.labelEx33 = new ControlEx.CcLabelEx();
            this.labelEx30 = new ControlEx.CcLabelEx();
            this.labelEx31 = new ControlEx.CcLabelEx();
            this.labelEx28 = new ControlEx.CcLabelEx();
            this.labelEx29 = new ControlEx.CcLabelEx();
            this.labelEx26 = new ControlEx.CcLabelEx();
            this.labelEx27 = new ControlEx.CcLabelEx();
            this.labelEx24 = new ControlEx.CcLabelEx();
            this.labelEx25 = new ControlEx.CcLabelEx();
            this.labelEx20 = new ControlEx.CcLabelEx();
            this.labelEx21 = new ControlEx.CcLabelEx();
            this.labelEx18 = new ControlEx.CcLabelEx();
            this.labelEx19 = new ControlEx.CcLabelEx();
            this.labelEx14 = new ControlEx.CcLabelEx();
            this.labelEx15 = new ControlEx.CcLabelEx();
            ...
            this.labelEx54 = new ControlEx.CcLabelEx();
            this.labelEx36 = new ControlEx.CcLabelEx();
            this.labelEx55 = new ControlEx.CcLabelEx();
            this.labelEx37 = new ControlEx.CcLabelEx();
            this.labelEx34 = new ControlEx.CcLabelEx();
            this.labelEx35 = new ControlEx.CcLabelEx();
            this.labelEx40 = new ControlEx.CcLabelEx();
            this.labelEx41 = new ControlEx.CcLabelEx();
            this.labelEx22 = new ControlEx.CcLabelEx();
            this.labelEx23 = new ControlEx.CcLabelEx();
            this.labelEx16 = new ControlEx.CcLabelEx();
            this.labelEx17 = new ControlEx.CcLabelEx();
            this.labelEx12 = new ControlEx.CcLabelEx();
            this.labelEx13 = new ControlEx.CcLabelEx();
            this.labelEx10 = new ControlEx.CcLabelEx();
            this.labelEx11 = new ControlEx.CcLabelEx();
            ...
            this.labelEx56 = new ControlEx.CcLabelEx();
            this.labelEx57 = new ControlEx.CcLabelEx();
            this.labelEx46 = new ControlEx.CcLabelEx();
            this.labelEx47 = new ControlEx.CcLabelEx();
            this.TabPageSeisouSystem = new TabPage();
            this.labelEx49 = new ControlEx.CcLabelEx();
            this.GroupBoxEx1 = new ControlEx.GroupBoxEx();
            this.labelEx50 = new ControlEx.CcLabelEx();
            this.LabelExServerVersion = new ControlEx.CcLabelEx();
            this.labelEx51 = new ControlEx.CcLabelEx();
            this.ButtonExDisConnectOracle = new ControlEx.CcButton();
            this.LabelExStatusOracle = new ControlEx.CcLabelEx();
            this.LabelExDataBaseNameOracle = new ControlEx.CcLabelEx();
            this.LabelExServerNameOracle = new ControlEx.CcLabelEx();
            this.ButtonExConnectOracle = new ControlEx.CcButton();
            this.labelEx48 = new ControlEx.CcLabelEx();
            ...
            this.TableLayoutPanelExBase.Controls.Add(this.CcMenuStrip1, 0, 0);
            ...
            treeNode97.Name = "NodeISO0000";
            treeNode97.Text = "　　環境マネジメントマニュアル";
            treeNode98.Name = "NodeISO0100";
            treeNode98.Text = "１　適用規格";
            treeNode99.Name = "NodeISO0200";
            treeNode99.Text = "２　引用規格";
            treeNode100.Name = "NodeISO0300";
            treeNode100.Text = "３　用語及び定義";
            treeNode101.Name = "NodeISO0410";
            treeNode101.Text = "４.１　組織及びその状況の理解";
            treeNode102.Name = "NodeISO0420";
            treeNode102.Text = "４.２　利害関係者のニーズ及び期待の理解";
            treeNode103.Name = "NodeISO0430";
            treeNode103.Text = "４.３　環境マネジメントシステムの適用範囲の決定";
            treeNode104.Name = "NodeISO0440";
            treeNode104.Text = "４.４　環境マネジメントシステム";
            treeNode105.Name = "NodeISO0400";
            treeNode105.Text = "４　組織の状況";
            treeNode106.Name = "NodeISO0510";
            treeNode106.Text = "５.１　リーダーシップ及びコミットメント";
            treeNode107.Name = "NodeISO0520";
            treeNode107.Text = "５.２　環境方針";
            treeNode108.Name = "NodeISO0530";
            treeNode108.Text = "５.３　組織の役割、責任及び権限";
            treeNode109.Name = "NodeISO0500";
            treeNode109.Text = "５　リーダーシップ";
            treeNode110.Name = "NodeISO0611";
            treeNode110.Text = "６.１.１　一般(リスク及び機会一覧表)";
            treeNode111.Name = "NodeISO0612";
            treeNode111.Text = "６.１.２　環境側面";
            treeNode112.Name = "NodeISO0613";
            treeNode112.Text = "６.１.３　順守義務(法的要求事項及びその他の要求事項)";
            treeNode113.Name = "NodeISO0614";
            treeNode113.Text = "６.１.４　取組みのための計画策定";
            treeNode114.Name = "NodeISO0610";
            treeNode114.Text = "６.１　リスク及び機会への取組み";
            treeNode115.Name = "NodeISO0621";
            treeNode115.Text = "６.２.１　環境目標";
            treeNode116.Name = "NodeISO0622";
            treeNode116.Text = "６.２.２　環境目標を達成するための取組みの計画策定";
            treeNode117.Name = "NodeISO0620";
            treeNode117.Text = "６.２　環境目標及びそれを達成するための計画策定(環境マネジメントプログラム)";
            treeNode118.Name = "NodeISO0600";
            treeNode118.Text = "６　計画";
            treeNode119.Name = "NodeISO0710";
            treeNode119.Text = "７.１　資源";
            treeNode120.Name = "NodeISO0720";
            treeNode120.Text = "７.２　力量";
            treeNode121.Name = "NodeISO0730";
            treeNode121.Text = "７.３　認識";
            treeNode122.Name = "NodeISO0741";
            treeNode122.Text = "７.４.１　一般";
            treeNode123.Name = "NodeISO0742";
            treeNode123.Text = "７.４.２　内部コミュニケーション";
            treeNode124.Name = "NodeISO0743";
            treeNode124.Text = "７.４.３　外部コミュニケーション";
            treeNode125.Name = "NodeISO0740";
            treeNode125.Text = "７.４　コミュニケーション";
            treeNode126.Name = "NodeISO0751";
            treeNode126.Text = "７.５.１　一般";
            treeNode127.Name = "NodeISO0752";
            treeNode127.Text = "７.５.２　作成及び更新";
            treeNode128.Name = "NodeISO0753";
            treeNode128.Text = "７.５.３　文書化した情報の管理";
            treeNode129.Name = "NodeISO0750";
            treeNode129.Text = "７.５　文書管理";
            treeNode130.Name = "NodeISO0700";
            treeNode130.Text = "７　支援(サポート)";
            treeNode131.Name = "NodeISO0810";
            treeNode131.Text = "８.１　運用の計画及び管理";
            treeNode132.Name = "NodeISO0821";
            treeNode132.Text = "８.２.１　緊急事態の可能性の特定";
            treeNode133.Name = "NodeISO0822";
            treeNode133.Text = "８.２.２　緊急事態対応手順書の作成";
            treeNode134.Name = "NodeISO0823";
            treeNode134.Text = "８.２.３　緊急事態対応訓練(対応手順のテスト)";
            treeNode135.Name = "NodeISO0824";
            treeNode135.Text = "８.２.４　手順書の見直し";
            treeNode136.Name = "NodeISO0825";
            treeNode136.Text = "８.２.５　取引先を含む利害関係者への情報提供";
            treeNode137.Name = "NodeISO0820";
            treeNode137.Text = "８.２　緊急事態への準備及び対応";
            treeNode138.Name = "NodeISO0800";
            treeNode138.Text = "８　運用";
            treeNode139.Name = "NodeISO0911";
            treeNode139.Text = "９.１.１　一般";
            treeNode140.Name = "NodeISO0912";
            treeNode140.Text = "９.１.２　順守評価";
            treeNode141.Name = "NodeISO0910";
            treeNode141.Text = "９.１　監視、測定、分析及び評価";
            treeNode142.Name = "NodeISO0920";
            treeNode142.Text = "９.２　内部監査";
            treeNode143.Name = "NodeISO0930";
            treeNode143.Text = "９.３　マネジメントレビュー";
            treeNode144.Name = "NodeISO0900";
            treeNode144.Text = "９　パフォーマンス評価";
            treeNode145.Name = "NodeISO1010";
            treeNode145.Text = "１０.１　一般";
            treeNode146.Name = "NodeISO1020";
            treeNode146.Text = "１０.２　不適合及び是正処置";
            treeNode147.Name = "NodeISO1030";
            treeNode147.Text = "１０.３　継続的改善";
            treeNode148.Name = "NodeISO1000";
            treeNode148.Text = "１０改善";
            treeNode149.Name = "ノード1";
            treeNode149.Text = "ISO14001";
            treeNode150.Name = "NodeRik00";
            treeNode150.Text = "00　巡回指導資料";
            treeNode151.Name = "NodeRik01";
            treeNode151.Text = "01　運転者台帳";
            treeNode152.Name = "NodeRik02";
            treeNode152.Text = "02　運行管理規定";
            treeNode153.Name = "NodeRik03";
            treeNode153.Text = "03　点呼記録簿・点呼執行要領";
            treeNode154.Name = "NodeRik04";
            treeNode154.Text = "04　乗務記録(運転日報)";
            treeNode155.Name = "NodeRik05";
            treeNode155.Text = "05　運行計画及び勤務割当表";
            treeNode156.Name = "NodeRik06";
            treeNode156.Text = "06　乗務実績一覧表(拘束時間管理表)";
            treeNode157.Name = "NodeRik07";
            treeNode157.Text = "07　運行記録計による記録";
            treeNode158.Name = "NodeRik08";
            treeNode158.Text = "08　運行指示書";
            treeNode159.Name = "NodeRik09";
            treeNode159.Text = "09　受注伝票";
            treeNode160.Name = "NodeRik10";
            treeNode160.Text = "10　運行管理者・整備管理者選任届出書";
            treeNode161.Name = "NodeRik11";
            treeNode161.Text = "11　運行管理者資格者証";
            treeNode162.Name = "NodeRik12";
            treeNode162.Text = "12　運行管理者研修手帳";
            treeNode163.Name = "NodeRik13";
            treeNode163.Text = "13　整備管理者研修手帳";
            treeNode164.Name = "NodeRik14";
            treeNode164.Text = "14　教育実施計画";
            treeNode165.Name = "NodeRik15";
            treeNode165.Text = "15　運転記録証明書又は無事故無違反証明書";
            treeNode166.Name = "NodeRik16";
            treeNode166.Text = "16　乗務員指導記録簿";
            treeNode167.Name = "NodeRik17";
            treeNode167.Text = "17　適性診断受診結果票及び指導記録";
            treeNode168.Name = "NodeRik18";
            treeNode168.Text = "18　適性診断受診計画表";
            treeNode169.Name = "NodeRik19";
            treeNode169.Text = "19　事故記録簿";
            treeNode170.Name = "NodeRik20";
            treeNode170.Text = "20　自動車事故報告書";
            treeNode171.Name = "NodeRik21";
            treeNode171.Text = "21　事業報告書・事業実績報告書";
            treeNode172.Name = "NodeRik22";
            treeNode172.Text = "22　役員変更届出書";
            treeNode173.Name = "NodeRik23";
            treeNode173.Text = "23　車両台帳・自動車検査証の写し";
            treeNode174.Name = "NodeRik24";
            treeNode174.Text = "24　整備管理規定等の規定類";
            treeNode175.Name = "NodeRik25";
            treeNode175.Text = "25　点検整備記録簿";
            treeNode176.Name = "NodeRik26";
            treeNode176.Text = "26　日常点検基準";
            treeNode177.Name = "NodeRik27";
            treeNode177.Text = "27　日常点検表";
            treeNode178.Name = "NodeRik28";
            treeNode178.Text = "28　定期点検基準";
            treeNode179.Name = "NodeRik29";
            treeNode179.Text = "29　定期点検整備実施計画表";
            treeNode180.Name = "NodeRik30";
            treeNode180.Text = "30　賃金台帳";
            treeNode181.Name = "NodeRik31";
            treeNode181.Text = "31　健康診断書・健康診断記録簿";
            treeNode182.Name = "NodeRik32";
            treeNode182.Text = "32　就業規則";
            treeNode183.Name = "NodeRik33";
            treeNode183.Text = "33　３６協定";
            treeNode184.Name = "NodeRik34";
            treeNode184.Text = "34　出勤簿";
            treeNode185.Name = "NodeRik35";
            treeNode185.Text = "35　運輸安全マネジメント関係";
            treeNode186.Name = "NodeRik36";
            treeNode186.Text = "36　労災保険加入台帳";
            treeNode187.Name = "NodeRik37";
            treeNode187.Text = "37　雇用保険加入台帳";
            treeNode188.Name = "NodeRik38";
            treeNode188.Text = "38　健康保険加入台帳・厚生年金加入台帳";
            treeNode189.Name = "ノード2";
            treeNode189.Text = "陸運局";
            ...
            this.PanelExRight.Controls.Add(this.ButtonExDisConnectSqlServer);
            this.PanelExRight.Controls.Add(this.ButtonExConnectSqlServer);
            this.PanelExRight.Controls.Add(this.LabelExStatusSqlServer);
            this.PanelExRight.Controls.Add(this.LabelExDataBaseNameSqlServer);
            ...
            this.ButtonExDisConnectSqlServer.Click += this.ButtonEx_Click;
            // 
            ...
            this.ButtonExConnectSqlServer.Click += this.ButtonEx_Click;
            // 
            // LabelExStatusSqlServer
            // 
            this.LabelExStatusSqlServer.ForeColor = Color.DimGray;
            this.LabelExStatusSqlServer.Location = new Point(36, 108);
            this.LabelExStatusSqlServer.Name = "LabelExStatusSqlServer";
            this.LabelExStatusSqlServer.Size = new Size(332, 20);
            this.LabelExStatusSqlServer.TabIndex = 7;
            this.LabelExStatusSqlServer.Text = "状態：";
            this.LabelExStatusSqlServer.TextAlign = ContentAlignment.MiddleLeft;
            // 
            // LabelExDataBaseNameSqlServer
            // 
            this.LabelExDataBaseNameSqlServer.ForeColor = Color.DimGray;
            this.LabelExDataBaseNameSqlServer.Location = new Point(36, 84);
            this.LabelExDataBaseNameSqlServer.Name = "LabelExDataBaseNameSqlServer";
            this.LabelExDataBaseNameSqlServer.Size = new Size(332, 20);
            this.LabelExDataBaseNameSqlServer.TabIndex = 6;
            this.LabelExDataBaseNameSqlServer.Text = "接続先データベース：";
            this.LabelExDataBaseNameSqlServer.TextAlign = ContentAlignment.MiddleLeft;
            // 
            // LabelExServerNameSqlServer
            // 
            this.LabelExServerNameSqlServer.ForeColor = Color.DimGray;
            this.LabelExServerNameSqlServer.Location = new Point(36, 60);
            this.LabelExServerNameSqlServer.Name = "LabelExServerNameSqlServer";
            this.LabelExServerNameSqlServer.Size = new Size(332, 20);
            this.LabelExServerNameSqlServer.TabIndex = 5;
            this.LabelExServerNameSqlServer.Text = "接続先サーバー：";
            this.LabelExServerNameSqlServer.TextAlign = ContentAlignment.MiddleLeft;
            // 
            // labelEx2
            // 
            ...
            // labelEx1
            // 
            this.labelEx1.Font = new Font("Yu Gothic UI", 9.75F, FontStyle.Regular, GraphicsUnit.Point, 128);
            this.labelEx1.ForeColor = Color.Black;
            ...
            this.TabPageOffice.Controls.Add(this.labelEx53);
            this.TabPageOffice.Controls.Add(this.labelEx38);
            this.TabPageOffice.Controls.Add(this.labelEx39);
            this.TabPageOffice.Controls.Add(this.labelEx44);
            ...
            this.labelEx52.Text = "　車両の稼働一覧を表示";
            this.labelEx52.TextAlign = ContentAlignment.MiddleLeft;
            // 
            // labelEx53
            // 
            ...
            this.labelEx53.Tag = "CarWorkingDays";
            this.labelEx53.Text = "車両稼働表";
            this.labelEx53.TextAlign = ContentAlignment.MiddleLeft;
            this.labelEx53.Click += this.Label_SqlServer_Click;
            this.labelEx53.MouseEnter += this.Label_MouseEnter;
            this.labelEx53.MouseLeave += this.Label_MouseLeave;
            // 
            // labelEx38
            // 
            this.labelEx38.ForeColor = Color.DimGray;
            this.labelEx38.Location = new Point(16, 368);
            this.labelEx38.Name = "labelEx38";
            this.labelEx38.Size = new Size(344, 20);
            this.labelEx38.TabIndex = 43;
            this.labelEx38.Text = "　各種資格証の管理をします";
            this.labelEx38.TextAlign = ContentAlignment.MiddleLeft;
            // 
            // labelEx39
            // 
            this.labelEx39.Font = new Font("Yu Gothic UI Semibold", 9F, FontStyle.Bold);
            this.labelEx39.ForeColor = Color.Black;
            this.labelEx39.Location = new Point(16, 348);
            this.labelEx39.Name = "labelEx39";
            this.labelEx39.Size = new Size(344, 20);
            this.labelEx39.TabIndex = 42;
            this.labelEx39.Tag = "CertificationList";
            this.labelEx39.Text = "有資格者一覧";
            this.labelEx39.TextAlign = ContentAlignment.MiddleLeft;
            this.labelEx39.Click += this.Label_SqlServer_Click;
            this.labelEx39.MouseEnter += this.Label_MouseEnter;
            this.labelEx39.MouseLeave += this.Label_MouseLeave;
            // 
            // labelEx44
            // 
            this.labelEx44.ForeColor = Color.DimGray;
            this.labelEx44.Location = new Point(376, 128);
            this.labelEx44.Name = "labelEx44";
            this.labelEx44.Size = new Size(344, 20);
            this.labelEx44.TabIndex = 41;
            this.labelEx44.Text = "　台東区";
            this.labelEx44.TextAlign = ContentAlignment.MiddleLeft;
            // 
            // labelEx45
            // 
            ...
            this.labelEx45.Click += this.Label_SqlServer_Click;
            this.labelEx45.MouseEnter += this.Label_MouseEnter;
            this.labelEx45.MouseLeave += this.Label_MouseLeave;
            // 
            // labelEx42
            // 
            this.labelEx42.ForeColor = Color.DimGray;
            this.labelEx42.Location = new Point(376, 80);
            this.labelEx42.Name = "labelEx42";
            this.labelEx42.Size = new Size(344, 20);
            this.labelEx42.TabIndex = 39;
            this.labelEx42.Text = "　台東区";
            this.labelEx42.TextAlign = ContentAlignment.MiddleLeft;
            // 
            // labelEx43
            // 
            this.labelEx43.Font = new Font("Yu Gothic UI Semibold", 9F, FontStyle.Bold, GraphicsUnit.Point, 128);
            this.labelEx43.ForeColor = Color.Black;
            this.labelEx43.Location = new Point(376, 60);
            this.labelEx43.Name = "labelEx43";
            this.labelEx43.Size = new Size(344, 20);
            this.labelEx43.TabIndex = 38;
            this.labelEx43.Tag = "CollectionWeightTaitouList";
            this.labelEx43.Text = "台東古紙収集量集計表";
            this.labelEx43.TextAlign = ContentAlignment.MiddleLeft;
            this.labelEx43.Click += this.Label_SqlServer_Click;
            ...
            this.labelEx30.Location = new Point(16, 320);
            this.labelEx30.Name = "labelEx30";
            this.labelEx30.Size = new Size(344, 20);
            this.labelEx30.TabIndex = 31;
            this.labelEx30.Text = "　許可情報を登録します";
            this.labelEx30.TextAlign = ContentAlignment.MiddleLeft;
            // 
            // labelEx31
            // 
            this.labelEx31.Font = new Font("Yu Gothic UI Semibold", 9F, FontStyle.Bold);
            this.labelEx31.ForeColor = Color.Black;
            this.labelEx31.Location = new Point(16, 300);
            this.labelEx31.Name = "labelEx31";
            this.labelEx31.Size = new Size(344, 20);
            this.labelEx31.TabIndex = 30;
            this.labelEx31.Tag = "StatusOfResidenceList";
            this.labelEx31.Text = "在留カード・特別永住者証明書";
            this.labelEx31.TextAlign = ContentAlignment.MiddleLeft;
            this.labelEx31.Click += this.Label_SqlServer_Click;
            this.labelEx31.MouseEnter += this.Label_MouseEnter;
            this.labelEx31.MouseLeave += this.Label_MouseLeave;
            // 
            // labelEx28
            // 
            this.labelEx28.ForeColor = Color.DimGray;
            this.labelEx28.Location = new Point(16, 272);
            ...
            // labelEx29
            // 
            this.labelEx29.Font = new Font("Yu Gothic UI Semibold", 9F, FontStyle.Bold);
            this.labelEx29.ForeColor = Color.Black;
            this.labelEx29.Location = new Point(16, 252);
            ...
            this.labelEx29.Click += this.Label_SqlServer_Click;
            ...
            this.labelEx26.Location = new Point(16, 224);
            ...
            // labelEx27
            // 
            this.labelEx27.Font = new Font("Yu Gothic UI Semibold", 9F, FontStyle.Bold);
            this.labelEx27.ForeColor = Color.Black;
            this.labelEx27.Location = new Point(16, 204);
            ...
            // labelEx21
            // 
            this.labelEx21.Font = new Font("Yu Gothic UI Semibold", 9F, FontStyle.Bold);
            ...
            this.labelEx21.Click += this.Label_SqlServer_Click;
            ...
            // labelEx19
            // 
            this.labelEx19.Font = new Font("Yu Gothic UI Semibold", 9F, FontStyle.Bold);
            ...
            this.labelEx19.Click += this.Label_SqlServer_Click;
            ...
            this.labelEx14.Text = "　千代田区に配車された従業員を集計します";
            this.labelEx14.TextAlign = ContentAlignment.MiddleLeft;
            // 
            // labelEx15
            // 
            this.labelEx15.Font = new Font("Yu Gothic UI Semibold", 9F, FontStyle.Bold);
            ...
            this.labelEx15.Tag = "CollectionWeightChiyoda";
            this.labelEx15.Text = "千代田区配車集計表";
            this.labelEx15.TextAlign = ContentAlignment.MiddleLeft;
            this.labelEx15.Click += this.Label_SqlServer_Click;
            this.labelEx15.MouseEnter += this.Label_MouseEnter;
            this.labelEx15.MouseLeave += this.Label_MouseLeave;
            // 
            // labelEx8
            // 
            this.labelEx8.ForeColor = Color.DimGray;
            this.labelEx8.Location = new Point(16, 80);
            ...
            // labelEx9
            // 
            this.labelEx9.Font = new Font("Yu Gothic UI Semibold", 9F, FontStyle.Bold);
            this.labelEx9.ForeColor = Color.Black;
            this.labelEx9.Location = new Point(16, 60);
            ...
            this.labelEx9.Click += this.Label_SqlServer_Click;
            ...
            this.labelEx6.Location = new Point(16, 32);
            ...
            // labelEx7
            // 
            this.labelEx7.Font = new Font("Yu Gothic UI Semibold", 9F, FontStyle.Bold);
            this.labelEx7.ForeColor = Color.Black;
            this.labelEx7.Location = new Point(16, 12);
            ...
            this.labelEx7.Click += this.Label_SqlServer_Click;
            ...
            this.TabPageAdachi.Controls.Add(this.labelEx17);
            this.TabPageAdachi.Controls.Add(this.labelEx12);
            this.TabPageAdachi.Controls.Add(this.labelEx13);
            this.TabPageAdachi.Controls.Add(this.labelEx10);
            this.TabPageAdachi.Controls.Add(this.labelEx11);
            ...
            this.labelEx23.Click += this.Label_SqlServer_Click;
            this.labelEx23.MouseEnter += this.Label_MouseEnter;
            this.labelEx23.MouseLeave += this.Label_MouseLeave;
            // 
            // labelEx16
            // 
            this.labelEx16.ForeColor = Color.DimGray;
            this.labelEx16.Location = new Point(16, 176);
            this.labelEx16.Name = "labelEx16";
            this.labelEx16.Size = new Size(344, 20);
            this.labelEx16.TabIndex = 19;
            this.labelEx16.Text = "　台帳の作成・印刷";
            this.labelEx16.TextAlign = ContentAlignment.MiddleLeft;
            // 
            // labelEx17
            // 
            this.labelEx17.Font = new Font("Yu Gothic UI Semibold", 9F, FontStyle.Bold);
            this.labelEx17.ForeColor = Color.Black;
            this.labelEx17.Location = new Point(16, 156);
            this.labelEx17.Name = "labelEx17";
            this.labelEx17.Size = new Size(344, 20);
            this.labelEx17.TabIndex = 18;
            this.labelEx17.Tag = "CarList";
            this.labelEx17.Text = "車両台帳";
            this.labelEx17.TextAlign = ContentAlignment.MiddleLeft;
            this.labelEx17.Click += this.Label_SqlServer_Click;
            this.labelEx17.MouseEnter += this.Label_MouseEnter;
            this.labelEx17.MouseLeave += this.Label_MouseLeave;
            // 
            // labelEx12
            // 
            this.labelEx12.ForeColor = Color.DimGray;
            this.labelEx12.Location = new Point(16, 80);
            this.labelEx12.Name = "labelEx12";
            this.labelEx12.Size = new Size(344, 20);
            this.labelEx12.TabIndex = 17;
            this.labelEx12.Text = "　配車表を作成します";
            this.labelEx12.TextAlign = ContentAlignment.MiddleLeft;
            // 
            // labelEx13
            // 
            this.labelEx13.Font = new Font("Yu Gothic UI Semibold", 9F, FontStyle.Bold);
            this.labelEx13.ForeColor = Color.Black;
            this.labelEx13.Location = new Point(16, 60);
            this.labelEx13.Name = "labelEx13";
            this.labelEx13.Size = new Size(344, 20);
            this.labelEx13.TabIndex = 16;
            this.labelEx13.Tag = "FirstRollColl";
            this.labelEx13.Text = "配車表";
            this.labelEx13.TextAlign = ContentAlignment.MiddleLeft;
            this.labelEx13.Click += this.Label_SqlServer_Click;
            this.labelEx13.MouseEnter += this.Label_MouseEnter;
            this.labelEx13.MouseLeave += this.Label_MouseLeave;
            // 
            // labelEx10
            // 
            ...
            this.labelEx10.Text = "　台帳の作成・印刷";
            this.labelEx10.TextAlign = ContentAlignment.MiddleLeft;
            // 
            // labelEx11
            // 
            ...
            this.labelEx11.Tag = "StaffList";
            this.labelEx11.Text = "従事者台帳";
            this.labelEx11.TextAlign = ContentAlignment.MiddleLeft;
            this.labelEx11.Click += this.Label_SqlServer_Click;
            this.labelEx11.MouseEnter += this.Label_MouseEnter;
            this.labelEx11.MouseLeave += this.Label_MouseLeave;
            // 
            // labelEx5
            // 
            this.labelEx5.ForeColor = Color.DimGray;
            this.labelEx5.Location = new Point(16, 32);
            ...
            // labelEx4
            // 
            this.labelEx4.Font = new Font("Yu Gothic UI Semibold", 9F, FontStyle.Bold);
            this.labelEx4.ForeColor = Color.Black;
            this.labelEx4.Location = new Point(16, 12);
            ...
            this.labelEx4.Click += this.Label_SqlServer_Click;
            ...
            this.labelEx47.Click += this.Label_SqlServer_Click;
        ...
        private ControlEx.CcLabelEx LabelExPcName;
        private ControlEx.CcLabelEx LabelExIpAddress;
        private ControlEx.CcLabelEx labelEx1;
        private ControlEx.CcLabelEx LabelExStatusSqlServer;
        private ControlEx.CcLabelEx LabelExDataBaseNameSqlServer;
        private ControlEx.CcLabelEx LabelExServerNameSqlServer;
        ...
        private ControlEx.CcLabelEx LabelExLocation;
        ...
        private ControlEx.CcLabelEx labelEx11;
        private ControlEx.CcLabelEx labelEx12;
        private ControlEx.CcLabelEx labelEx13;
        private ControlEx.CcLabelEx labelEx14;
        private ControlEx.CcLabelEx labelEx15;
        private ControlEx.CcLabelEx labelEx16;
        private ControlEx.CcLabelEx labelEx17;
        private ControlEx.CcLabelEx labelEx18;
        private ControlEx.CcLabelEx labelEx19;
        private ControlEx.CcLabelEx labelEx20;
        private ControlEx.CcLabelEx labelEx21;
        private ControlEx.CcLabelEx labelEx22;
        private ControlEx.CcLabelEx labelEx23;
        private ControlEx.CcLabelEx labelEx24;
        private ControlEx.CcLabelEx labelEx25;
        private ControlEx.CcLabelEx labelEx26;
        private ControlEx.CcLabelEx labelEx27;
        private ControlEx.CcLabelEx labelEx28;
        private ControlEx.CcLabelEx labelEx29;
        private ControlEx.CcLabelEx labelEx30;
        private ControlEx.CcLabelEx labelEx31;
        private ControlEx.CcLabelEx labelEx32;
        private ControlEx.CcLabelEx labelEx33;
        private ControlEx.CcLabelEx labelEx42;
        private ControlEx.CcLabelEx labelEx43;
        private ControlEx.CcLabelEx labelEx40;
        private ControlEx.CcLabelEx labelEx41;
        private ControlEx.CcLabelEx labelEx44;
        private ControlEx.CcLabelEx labelEx45;
        private ControlEx.CcLabelEx labelEx36;
        private ControlEx.CcLabelEx labelEx37;
        private ControlEx.CcLabelEx labelEx34;
        private ControlEx.CcLabelEx labelEx35;
        private ControlEx.CcLabelEx labelEx38;
        private ControlEx.CcLabelEx labelEx39;
        private TabPage TabPageHaikibutu;
        private ControlEx.CcLabelEx labelEx46;
        private ControlEx.CcLabelEx labelEx47;
        ...
        private ControlEx.CcLabelEx labelEx48;
        private ControlEx.CcLabelEx LabelExStatusOracle;
        private ControlEx.CcLabelEx LabelExDataBaseNameOracle;
        private ControlEx.CcLabelEx LabelExServerNameOracle;
        private ControlEx.CcButton ButtonExDisConnectOracle;
        private ControlEx.CcLabelEx LabelExServerVersion;
        private ControlEx.CcLabelEx labelEx49;
        private ControlEx.CcLabelEx labelEx50;
        private ControlEx.CcLabelEx labelEx51;
        private ControlEx.CcLabelEx labelEx52;
        private ControlEx.CcLabelEx labelEx53;
        private ControlEx.CcLabelEx labelEx54;
        private ControlEx.CcLabelEx labelEx55;
        private ControlEx.CcLabelEx labelEx56;
        private ControlEx.CcLabelEx labelEx57;
    }
}