namespace Car {
    partial class CarDetail {
        ...
        private void InitializeComponent() {
            ...
            this.NumericUpDownExTotalDisplacement = new CcControl.CcNumericUpDown();
            this.NumericUpDownExRrAxisWeight = new CcControl.CcNumericUpDown();
            this.NumericUpDownExRfAxisWeight = new CcControl.CcNumericUpDown();
            this.NumericUpDownExFrAxisWeight = new CcControl.CcNumericUpDown();
            this.NumericUpDownExFfAxisWeight = new CcControl.CcNumericUpDown();
            this.NumericUpDownExHeight = new CcControl.CcNumericUpDown();
            this.NumericUpDownExWidth = new CcControl.CcNumericUpDown();
            this.NumericUpDownExLength = new CcControl.CcNumericUpDown();
            this.NumericUpDownExTotalVehicleWeight = new CcControl.CcNumericUpDown();
            this.NumericUpDownExVehicleWeight = new CcControl.CcNumericUpDown();
            this.NumericUpDownExMaximumLoadCapacity = new CcControl.CcNumericUpDown();
            this.NumericUpDownExCapacity = new CcControl.CcNumericUpDown();
