        ...
        private void SetSheetView(SheetView sheetView, SetControl setControl) {
            ...
            switch (setControl.SetCode) {
                ...
                case 1310817:                                                                                               // 江東８（新大）
                    ...
                    break;
                case 1310821:                                                                                               // 江東１４（新大）
                    sheetView.Cells[10, 17].Text = "江東区清掃事務所 /"; // 休憩場所
                    sheetView.Cells[12, 3].Text = "🔲　新江東清掃工場"; // 運搬先名①
                    sheetView.Cells[13, 3].Text = "🔲　新江東清掃工場"; // 運搬先名②
                    sheetView.Cells[14, 3].Text = "🔲　新江東清掃工場"; // 運搬先名③
                    sheetView.Cells[15, 3].Text = "🔲　新江東清掃工場"; // 運搬先名④
